...
const experiences = [
    {
        ...
        description: `During my first co-op experience at Northeastern, my team and I acted as the first point of communication for over 25,000 \
        users of Terra.bio, a cloud platform developed by the Broad for researchers to facilitate Google Cloud resource usage in a way that is \
    ...
    },
    {
        ...
        fully functional and driveable car and participate anually in the Formula Hybrid + Electric Competition. Here I was a member of the software team tasked with working on a full-stack web application \
    ...
    },
    {
        ...
        relevant_techs: "Python, pandas, DeepEval, Machine Learning, LLMs",
        description: `REAN Foundation is a non-profit company focused on increasing healthcare access and overall awareness through the creation`
    }
]
...
const Experience = () => (
    <Layout>
        <div className='experience-container'>
            ...
            <ul>
                <li>Spyder, Eclipse, IntelliJ, GitHub, Office Suite, VSCode, PyCharm, vim, nano, AWS, JIRA, Jenkins, Docker, React, Flask</li>
            </ul>
            <h3><b>coding languages</b></h3>
            <ul>
                <li>Java, Python, Racket, HTML, TypeScript, JavaScript, Linux/Bash, C++, C, x86 Assembly, React.js, MySQL</li>
            </ul>
